...
public:
	...
	HRESULT LoadShaderFilesAndInputLayouts(ID3D11Device* d3dDevice, WCHAR* szVSFileName, WCHAR* szPSFileName, int inputLayoutOption);
	...
	void RenderGameObjects(ID3D11DeviceContext* immediateContext, vector<GameObject*> gameObjects, ID3D11Buffer* constantBuffer, SSAOConstantBuffer* ssaoCB);
